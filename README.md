...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![Rust](https://img.shields.io/badge/Built_with-Rust_🦀-orange) ![Tauri](https://img.shields.io/badge/Framework-Tauri-blueviolet) ![Platform](https://img.shields.io/badge/Platform-Windows-0078D6)
...
<video src="showcase/video.mp4" autoplay loop muted playsinline style="width: 100%; max-width: 800px; display: block; margin: 20px 0; border-radius: 8px; box-shadow: 0 4px 20px rgba(0,0,0,0.5);"></video>
